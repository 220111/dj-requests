...
<header>
	<Navbar let:hidden let:toggle fluid={false} {navClass} {navDivClass}>
		<NavBrand href="/">
			<img src="/images/logo.svg" class="mr-3 h-6 sm:h-9" alt="DJ Requests Logo" />
		...
		<div class="flex items-center lg:order-2">
			...
			<Button href="/app/onboarding" class="ml-2" color="red">Get started</Button>
			<NavHamburger
				on:click={toggle}
		...
		>
			...
			<NavLi href="https://hmorin.com">Team</NavLi>
