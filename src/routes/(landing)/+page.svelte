...
<Section name="heroVisual">
    <div class="mr-auto place-self-center lg:col-span-7">
        ...
        <svelte:fragment slot="h1">Realtime Request Management for Live DJs</svelte:fragment>
        ...
        <a href="/app/onboarding"><Button size="xl" color="red" class="inline-flex items-center justify-center mr-3">Get started<ArrowRightOutline size="md" class="ml-2 -mr-1" /></Button> </a>
        </HeroHeader>
    </div>
